...
import * as $admin_data_sync from "./routes/admin/data-sync.tsx";
...
import * as $AdminDataSyncManager from "./islands/AdminDataSyncManager.tsx";
...
const manifest = {
  routes: {
    ...
    "./routes/admin/data-sync.tsx": $admin_data_sync,
  ...
  islands: {
    ...
    "./islands/AdminDataSyncManager.tsx": $AdminDataSyncManager,
